...
class FederalRegion(models.TextChoices):  # Федеральный округ
    ...
    KG01 = "KG01 - Баткенская область", "KG01 - Баткенская область"
    KG02 = "KG02 - Джалал-Абадская область", "KG02 - Джалал-Абадская область"
    KG03 = "KG03 - Иссык-Кульская область", "KG03 - Иссык-Кульская область"
    KG04 = "KG04 - Нарынская область", "KG04 - Нарынская область"
    KG05 = "KG05 - Ошская область", "KG05 - Ошская область"
    KG06 = "KG06 - Таласская область", "KG06 - Таласская область"
    KG07 = "KG07 - Чуйская область", "KG07 - Чуйская область"
    KG08 = "KG08 - Бишкек", "KG08 - Бишкек"
    KG09 = "KG09 - Ош", "KG09 - Ош"
...
class MemberCats(models.Model):
    class AgeCategory(models.TextChoices):  # возрастная категория
        ...
        JW2 = "Юниорки 19-21", "Юниорки 19-21"
        JM3 = "Юниоры 16-18", "Юниоры 16-18"
        JW4 = "Юниорки 16-18", "Юниорки 16-18"
        JM5 = "Юноши 14-15", "Юноши 14-15"
        JW6 = "Девушки 14-15", "Девушки 14-15"
        JW7 = "Суб. юниоры девочки 15", "Суб. юниоры девочки 15"
        JW8 = "Суб. юниоры мальчики 15", "Суб. юниоры мальчики 15"
